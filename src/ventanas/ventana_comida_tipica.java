...
public class ventana_comida_tipica extends JFrame {
	...
	public ventana_comida_tipica() {
		...
		JLabel lblNewLabel = new JLabel("COMIDA TIPICA \"HOTEL VILLA PALMA REAL\"");
		...
		JLabel lblIngreseSusCredenciales = new JLabel("COMIDA TIPICA");
		...
		JLabel lblPlatillo = new JLabel("Platillo Tipico");
		...
		cbxPlatillo.setModel(new DefaultComboBoxModel(
		...
		btnVerPlatillos.setBounds(179, 21, 162, 32);
	...
	public void asignarPrecios() {
		if (cbxPlatillo.getSelectedItem().equals("1. Baleadas")) {
			txtPrecio.setText("30.00");
		} else {
			if (cbxPlatillo.getSelectedItem().equals("2. Pollo chuco")) {
				txtPrecio.setText("150.00");
			} else {
				if (cbxPlatillo.getSelectedItem().equals("3. Enchiladas")) {
					txtPrecio.setText("100.00");
				} else {
					if (cbxPlatillo.getSelectedItem().equals("4. Catrachas")) {
						txtPrecio.setText("100.00");
					} else {
						if (cbxPlatillo.getSelectedItem().equals("5. Carne Asada")) {
