...
public class ventana_habitaciones extends JFrame {
	...
	public ventana_habitaciones() {
		...
		JLabel lblNewLabel = new JLabel("RESERVACION DE HABITACIONES \"HOTEL VILLA PALMA REAL\"");
		...
		JLabel lblIngreseSusCredenciales = new JLabel("HABITACIONES");
		...
		JLabel lblTiempoDeEstadia = new JLabel("Estadia:");
		...
		txtEstadia = new JTextField();
		txtEstadia.setFont(new Font("Segoe UI", Font.PLAIN, 15));
		txtEstadia.setColumns(10);
		txtEstadia.setBounds(10, 335, 446, 32);
		panel_2.add(txtEstadia);
		...
		cbxHabitacion.setModel(new DefaultComboBoxModel(
				new String[] { "Habitacion Sencilla", "Habitacion Doble", "Habitacion Multiple" }));
	...
	public void guardarRegistro() {
		if (txtNombre.getText().toString().equals("") || txtIdentidad.getText().toString().equals("")
				|| txtEstadia.getText().toString().equals("") || txtPago.getText().toString().equals("")) {
			...
			estadia = txtEstadia.getText().toString();
