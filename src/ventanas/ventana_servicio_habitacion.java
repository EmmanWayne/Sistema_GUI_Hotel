...
public class ventana_servicio_habitacion extends JFrame {
	...
	public ventana_servicio_habitacion() {
		setResizable(false);
		...
		JLabel lblNewLabel = new JLabel("SERVICIO A LA HABITACION \"HOTEL VILLA PALMA REAL\"");
		...
		JLabel lblIngreseSusCredenciales = new JLabel("SERVICIO A LA HABITACION");
		...
		txtServicio.setFont(new Font("Segoe UI", Font.PLAIN, 15));
		txtServicio.setColumns(10);
		txtServicio.setBounds(10, 335, 446, 32);
		panel_2.add(txtServicio);
		...
		cbxHabitacion.setModel(new DefaultComboBoxModel(new String[] {"Habitacion 500", "Habitacion 501", "Habitacion 502", "Habitacion 503", "Habitacion 504", "Habitacion 505", "Habitacion 506", "Habitacion 507", "Habitacion 508", "Habitacion 509", "Habitacion 510"}));
		...
		panel_2.add(lblNumero);
		 ...
		 cbxCliente.setModel(new DefaultComboBoxModel(new String[] {"Carlos Alberto Sabillon Flores", "Alberto Rodrigo Gomez Perez", "Luisa Camila Perez Gonzales"}));
	...
	public void guardarRegistro() {
		if (txtServicio.getText().toString().equals("") || txtPago.getText().toString().equals("")) {
			...
			estadia = txtServicio.getText().toString();
